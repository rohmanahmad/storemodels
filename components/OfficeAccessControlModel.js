...
class Model extends PostgresORM {
    ...
    get schemas () {
        return {
            ...
            is_only_own_access: { // ini hanya diperbolehkan read-write yg dimiliki saja, ex: produk, review
                type: Boolean,
                stringType: 'boolean',
                size: 0,
                isNullable: true,
    ...
    get hasMany () {
        return {
            ref_office_user_id: {table: 'office_users', local: 'ref_office_user_id', foreign: '_id'}
        }
    }
